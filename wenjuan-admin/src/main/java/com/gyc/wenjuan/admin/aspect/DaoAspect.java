package com.gyc.wenjuan.admin.aspect;
...
import com.gyc.wenjuan.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* com.gyc.wenjuan.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* com.gyc.wenjuan.*.dao.*.insert*(..))")
